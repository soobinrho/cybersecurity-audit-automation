...
Example:
    ...
    >>> python ./caa_supabase_uid_{USER_UID}.py

Example:
    >>> # If you want to make direct changes to the source code, use the debugging mode to help you.
    >>> python ./caa_supabase_uid_{USER_UID}.py -d

Example:
    >>> # How to see all available parameters.
    >>> python ./caa_supabase_uid_{USER_UID}.py -h
"""

# This section is auto generated by https://caa.nsustain.com
# -----------------------------------------------------------------------------
# Generated by:
# Generated at:
# Designed for:
