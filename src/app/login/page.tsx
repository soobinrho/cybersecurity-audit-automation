      ...
      <div className="flex items-center flex-col w-xs rounded-lg border border-gray-200 bg-white p-6 text-center shadow dark:border-gray-600 dark:bg-dark-mode-menu dark:hover:border-gray-500">
        <div className="flex items-center justify-center w-full gap-2">
            <svg
              width="25"
              height="26"
              className="dark:fill-dark-mode-text-main stroke-0"
              viewBox="0 0 25 26"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
                className="fill-light-mode-text-main dark:fill-gray-400 stroke-0"
              ...
              <defs>
                <rect
                  width="25"
                  height="24"
                  transform="translate(24.5 0.5) rotate(90)"
                />
              </defs>
            </svg>

          <h5 className="text-xl font-bold tracking-tight text-light-mode-text-main dark:text-gray-400">
            caa
          </h5>
        </div>
        <form
        ...
        {Object.values(providerMap).map((provider) => (
          ...
          >
            <Button
              className="mt-3 w-full dark:shadow-none shadow-cyan-600 shadow-sm dark:bg-light-mode-text-main/90 dark:text-dark-mode-text-main dark:hover:bg-white/20"
              type="submit"
            >
              <div className="flex items-center justify-center w-full gap-2">
