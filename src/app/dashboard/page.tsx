  ...
  return (
    <div>
      ...
      <section className="pb-4">
        ...
        <p>
          [This is generated at server side at request, not at build time] Load
        ...
        <p>
          This file is your own unique Python script, which has just been baked
          in by our server to contain a disposable API key with access rights to
      ...
      <section className="pb-4">
        ...
        <p>
          ...
          remediation action flows. Your dashboard will get updated in real-time
          with the security controls status and remediation results.
        </p>
      </section>
      <section className="pb-4">
