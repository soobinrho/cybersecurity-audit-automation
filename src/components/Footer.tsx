  ...
  return (
    <div
      className={
        `${className}` +
        " " +
        "w-full h-full justify-center align-middle flex gap-2 sm:gap-5 text-xs md:text-sm tracking-tight sm:tracking-wide px-4 py-4 text-foregroud/60 text-nowrap overflow-hidden md:border-l-[0.08rem] border-dashed"
      }
    >
      <a
